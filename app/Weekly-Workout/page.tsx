...
function selectBestWorkout(
  ...
  return {
    ...
    exercises: best.workout.exerciseIds
  ...
  return (
    <main className="min-h-screen bg-black p-6 pb-24 text-white">
      ...
      <section className="mt-6 rounded-2xl border border-green-800 bg-green-950/50 p-4">
        ...
        <Link
          href={`/workouts?day=${todayIndex}${suggestionsByDay?.[dayByIndex[todayIndex]]?.workoutId ? `&workoutId=${suggestionsByDay[dayByIndex[todayIndex]].workoutId}` : ""}`}
        ...
        {orderedDays.map((day) => {
          ...
          return (
            ...
            >
              ...
              <Link
                href={`/workouts?day=${day}${suggestedWorkout?.workoutId ? `&workoutId=${suggestedWorkout.workoutId}` : ""}`}
