...
export const defaultExercises: Exercise[] = [
  ...
  { id: "ex-bd-73", name: "Mirror Defense (Reaktion)", durationMin: 8, category: "Basketball", subcategory: "Defense", notes: "Mit Partner: schnelle Reaktion auf Richtungswechsel", metricKeys: ["time", "intensity"], targetByMetric: { time: 6, intensity: 8 }, trackingType: "reps", targetValue: 6, restSeconds: 45 },
  ...
  { id: "ex-bp-92", name: "Pick-and-Roll Reads", durationMin: 14, category: "Basketball", subcategory: "Passing", notes: "Pocket / Lob / Skip-Pass entscheiden", metricKeys: ["reps", "intensity"], targetByMetric: { reps: 18, intensity: 7 }, trackingType: "reps", targetValue: 18, videoUrl: "https://www.youtube.com/results?search_query=pick+and+roll+passing+reads", restSeconds: 60 },
  // Basketball – Taktik (neu)
  { id: "ex-bt-101", name: "Read & React (Solo)", durationMin: 14, category: "Basketball", subcategory: "Taktik", notes: "Spot-Up, Cut, Drift simulieren — 5 Phasen", metricKeys: ["reps", "intensity"], targetByMetric: { reps: 15, intensity: 7 }, trackingType: "reps", targetValue: 15, restSeconds: 30 },
  { id: "ex-bt-102", name: "P&R Decision-Making (Film)", durationMin: 12, category: "Basketball", subcategory: "Taktik", notes: "Video-Reps: Lese Hedge/Drop/Switch, eigene Lösung notieren", metricKeys: ["time", "intensity"], targetByMetric: { time: 12, intensity: 6 }, trackingType: "reps", targetValue: 12, videoUrl: "https://www.youtube.com/results?search_query=pick+and+roll+coverages+breakdown" },
  { id: "ex-bt-103", name: "Conceptual Walk-Through", durationMin: 10, category: "Basketball", subcategory: "Taktik", notes: "Set-Plays / Spacing-Konzepte mental durchgehen", metricKeys: ["time", "intensity"], targetByMetric: { time: 10, intensity: 5 }, trackingType: "reps", targetValue: 10 },
